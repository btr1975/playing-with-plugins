"""
CLI for playing_with_plugins
"""

from argparse import ArgumentParser

#  FIXME: This is an example you should delete it
from playing_with_plugins.example import print_hello, print_goodbye
...
def cli_argument_parser() -> ArgumentParser:
    ...
    """
    arg_parser = ArgumentParser(description="playing-with-plugins-cli")
